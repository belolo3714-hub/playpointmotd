#!/bin/bash
# PlayPoint Advanced MOTD Installer
...
cat << 'EOF' > /etc/update-motd.d/00-playpoint
#!/bin/bash
...
echo -e "${GREEN} Welcome to PlayPoint Datacenter! 🚀 ${RESET}\n"
...
chmod +x /etc/update-motd.d/00-playpoint

echo "🎉 PlayPoint MOTD Installed Successfully!"
