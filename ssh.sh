...
# ===========================================
# Secure SSH Setup + Custom MOTD - PlayPoint
# ===========================================

clear

echo -e "\033[1;36m🔐 PlayPoint - Secure SSH Configuration\033[0m"
...
bash <(curl -fsSL https://raw.githubusercontent.com/belolo3714-hub/playpointmotd/main/motd.sh)
...
echo -e "\033[1;37m📌 PlayPoint VPS setup completed.\033[0m"
